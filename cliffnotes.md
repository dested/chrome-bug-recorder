...
landing/                Marketing site → gripe.dested.com (own package.json, Bun)
  ...
  src/app/home.tsx      The whole landing page; capture-demo.tsx is the looping CSS hero demo
  src/styles/app.css    Tailwind v4 tokens mirroring ui.md (+ demo.css: the 16s hero timeline)
